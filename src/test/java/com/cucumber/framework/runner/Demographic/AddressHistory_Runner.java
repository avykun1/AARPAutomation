...
@CucumberOptions(features = { "classpath:featurefile/C71604_ContactDemographic/F511036_SF_AddressChanges/AbilityToTrackAddressHistory.feature" }, glue = {
...
public class AddressHistory_Runner extends AbstractTestNGCucumberTests {
	@BeforeClass
		...
		String strScenarioName = "Track Address History";
